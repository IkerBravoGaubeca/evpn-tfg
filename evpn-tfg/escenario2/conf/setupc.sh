...
ip link add vxlan1001 type vxlan id 1001 dstport 4789 dev eth1 local 10.0.0.6
ip link set vxlan1001 up

ip link add vxlan1002 type vxlan id 1002 dstport 4789 dev eth1 local 10.0.0.6
